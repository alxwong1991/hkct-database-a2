        ...
        <div class="row">
            ...
            foreach ($products_xml->product as $child) {
                if ($id == $child->pid) {
                    ...
                    //     echo " ：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：：<br/>";
                    //     echo "product id ：" . ($products_id + 1)  . "<br/>";
                    //     echo " -- //<br/>";
                    //     echo "xml title ：" . $title . "<br/>";
                    //     echo "xml description ：" . $description . "<br/>";
                    //     echo "xml price ：" . $price . "<br/>";
                    //     echo "img path ：" . $img . "<br/>";
                    //     $products_id++;
                    // }
                    ...
                    echo "<form action='products.php' method='post' enctype='multipart/form-data'>";
                    ...
                    // Add bag
                    echo "<button class='w-100 mb-2 mt-2 btn btn-lg rounded-4 btn-dark nav-color' type='submit' name='submit'>ADD TO SHOPPING BAG</button>";
                    echo "</div>";
