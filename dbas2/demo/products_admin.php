        ...
        <button class="carousel-control-next" type="button" data-bs-target="#myCarousel" data-bs-slide="next">
          ...
          <span class="visually-hidden">Next</span>
            ...
            <div class="col-6 d-flex justify-content-end mt-5 mb-5">
                ...
                <button class="btn btn-warning m-3" onclick="dp_on()">Delete Produc</button>
            </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content" style="background-color: rgba(48, 162, 141, 0.17)">
                            ...
                            <div class="modal-header p-5 pb-4 border-bottom-0">
                                <h2 class="fw-bold mb-0" style="font-size: 3rem; color: rgba(163, 16, 25, 0.86)">New Product</h2>
                                <!-- btn : X -->
                                <button onclick="off()" type="button" class="close" aria-label="Close" style="width:3vh;height:6vh;border:none;background-color:transparent;">
                            ...
                            <div class="modal-body p-5 pt-0">
                                <form action="products.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="title" class="form-control rounded-4" id="floatingInput" placeholder="name@example.com" required="required">
                                        <label for="floatingInput">Title</label>
                                    </div>

                                    <!-- // Price -->
                                    <div class="form-floating mb-3">
                                        <input type="text" name="price" class="form-control rounded-4" id="floatingPassword" placeholder="Password" required="required">
                                        <label for="floatingPassword">Price</label>
                                    </div>

                                    <!-- // Description -->
                                    <div class="form-floating mb-3">
                                        <input type="text" name="description" class="form-control rounded-4" id="floatingPassword" placeholder="Password" required="required">
                                        <label for="floatingPassword">Description</label>
                                    </div>

                                    <!-- // Image  -->
                                    <label for="fileToUpload" class="w-100 mb-2 btn btn-lg rounded-4 nav-color text-white" style=" border: 1px solid black;">
                                        Image
                                    </label>
                                    <input type="file" name="fileToUpload" id="fileToUpload">

                                    <!-- // Add Product  -->
                                    <button class="w-100 mb-2 btn btn-lg rounded-4 btn-dark nav-color" type="submit" name="submit">Add Product</button>
    ...
    padding-bottom: 3rem!important" tabindex="-1" role="dialog">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content" style="background-color: rgba(48, 162, 141, 0.17)">
                            ...
                            <!-- modal-header -->
                            <div class="modal-header p-5 pb-4 border-bottom-0">
                                <h2 class="fw-bold mb-0" style="font-size: 3rem; color: rgba(163, 16, 25, 0.86)">Delete Product</h2>
                                <!-- btn : X -->
